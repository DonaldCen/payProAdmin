<template>
  <a-drawer
    ...
    <a-form :form="form">
      ...
      <a-form-item label='身份证名称' v-bind="formItemLayout">
        <a-input readOnly v-decorator="['legalPersonName']"/>
      </a-form-item>
      <a-form-item label='营业执照' v-bind="formItemLayout">
        <a-input readOnly v-decorator="['busiLicenseNum']"/>
      </a-form-item>
      <a-form-item label='身份证号码' v-bind="formItemLayout">
        <a-input readOnly v-decorator="['idCardNumber']"/>
      </a-form-item>
    </a-form>
